...
class MarkedVideosAdapter(var context: Context, var itemClickListener: ItemClickListener, var itemBookmarkClickListener: ItemClickListener) : RecyclerView.Adapter<MarkedVideosAdapter.VideoViewHolder>() {

    private var videoList: List<MarkedVideo> = emptyList()

    @SuppressLint("NotifyDataSetChanged")
    fun submitList(videoList: List<MarkedVideo>) {
